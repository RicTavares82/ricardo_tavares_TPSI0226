...
for i in range(num - 1, 0, -1):
    ...
    som += ope
    print(f"{num} - {i} = {ope}")
print(f"O total da subtração dos valores é {som}")
som = 0
cont = 0
...
for i in range(num - 1, 0, -1):
    ...
    som += ope
    print(f"{num} * {i} = {ope}")
print(f"O total da multiplicação dos valores é {som}")
som = 0
cont = 0
...
for i in range(num - 1, 0, -1):
    ...
    ope = num / i
    som += ope
    print(f"{num} * {i} = {ope:.2f}")
print(f"O total da divisão dos valores é {som}")
print(f"O total de operações efetuadas foi {contatudo}")
